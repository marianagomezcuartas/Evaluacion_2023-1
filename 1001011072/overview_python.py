...
isinstance(hello,str)    #pregunto si hello es un str --> me habla del tipo o categoría de lo que he preguntado
...
#se pone el signo de admiración como si fuera creando un bloque en la aterminal
...
#! /usr/bin/python                                     -------->como tiene #! significa que es un comentario especial
...
hello='Hello World!'
print(f'{hello}')          #imprimir variables dentro de la cadena de caracteres
...
x=23456.5678545
print(f'{x:.2f}')       #se pone también el formato del punto flotante

"""__Activity__: Print with 3 decimal places"""

print(f'{x: .3f}')   #la variable, dos puntos, un punto, el numero de decimales que tengo y una f al final
